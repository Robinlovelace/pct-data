...
# mapshape("pct-bigdata/national/msoas.shp")
# ukmsoas <- shapefile("pct-bigdata/national/msoasmapshaped_25%.shp")
...
if(geo_level == "cua"){
  regions <- readOGR(dsn = "pct-bigdata/national/cuas-mf.geojson", layer = "OGRGeoJSON")
...
if(file.exists(paste0("pct-data/", region, "/rf.Rds"))){
  rf <- readRDS(paste0("pct-data/", region, "/rf.Rds")) # if you've loaded them
  rq <- readRDS(paste0("pct-data/", region, "/rq.Rds"))
...
# which paths succeeded (use the line ids)
...
if(exists("isolated")) file.create(paste0("pct-data/", region, "/isolated"))
...
dir.create(paste0("../pct-shiny/", region))
mess <- paste0("cp ../pct-shiny/coventry/* ../pct-shiny/", region)
system(mess)
