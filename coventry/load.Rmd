...
```{r, echo=FALSE}
if(!exists("la")) la <- "coventry" # create default LA name if none exists
```
...
min_zones <- 30 # minumum number of zones in study area before buffer used
...
of the model). That's  **`r pmflow`%** of flows, accounting for
